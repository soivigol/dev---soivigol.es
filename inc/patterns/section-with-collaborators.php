...
return array(
	...
	<figure class="wp-block-image size-large"><img src="' . esc_url( $url_theme ) . '/assets/img/logotype.png" alt="" class="wp-image-57"/></figure>
	<!-- /wp:image -->

	<!-- wp:image {"id":56,"sizeSlug":"large","linkDestination":"none","style":{"color":{"duotone":["#333","#CCC"]}}} -->
	<figure class="wp-block-image size-large"><img src="' . esc_url( $url_theme ) . '/assets/img/logotype.png" alt="" class="wp-image-56"/></figure>
	<!-- /wp:image -->

	<!-- wp:image {"id":55,"sizeSlug":"large","linkDestination":"none","style":{"color":{"duotone":["#333","#CCC"]}}} -->
	<figure class="wp-block-image size-large"><img src="' . esc_url( $url_theme ) . '/assets/img/logotype.png" alt="" class="wp-image-55"/></figure>
	<!-- /wp:image -->

	<!-- wp:image {"id":54,"sizeSlug":"large","linkDestination":"none","style":{"color":{"duotone":["#333","#CCC"]}}} -->
	<figure class="wp-block-image size-large"><img src="' . esc_url( $url_theme ) . '/assets/img/logotype.png" alt="" class="wp-image-54"/></figure>
	<!-- /wp:image -->

	<!-- wp:image {"id":53,"sizeSlug":"large","linkDestination":"none","style":{"color":{"duotone":["#333","#CCC"]}}} -->
	<figure class="wp-block-image size-large"><img src="' . esc_url( $url_theme ) . '/assets/img/logotype.png" alt="" class="wp-image-53"/></figure>
	<!-- /wp:image -->

	<!-- wp:image {"id":52,"sizeSlug":"large","linkDestination":"none","style":{"color":{"duotone":["#333","#CCC"]}}} -->
	<figure class="wp-block-image size-large"><img src="' . esc_url( $url_theme ) . '/assets/img/logotype.png" alt="" class="wp-image-52"/></figure>
	<!-- /wp:image --></figure>
	<!-- /wp:gallery -->
